...
import {sprite_akar_panel_split_row} from "../../../sprites/groups/akar/panel-split-row.js"
import {sprite_akar_panel_split_column} from "../../../sprites/groups/akar/panel-split-column.js"
			...
			<div class=taskbar>
				...
				<div class=actions>
					<button @click=${() => meta.layout.actions.split_pane(pane.id, false)}>
						${sprite_akar_panel_split_row}
					</button>

					<button @click=${() => meta.layout.actions.split_pane(pane.id, true)}>
						${sprite_akar_panel_split_column}
					</button>
