...
export const icon_tabler_artboard_filled = icon(svg`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-artboard-filled" width="44" height="44" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
